...
public class Randomizer {
	...
	private static void showTeams(ArrayList< ArrayList<Pair <String, ArrayList<String>>>> teamList){
		...
		for(int i = 0; i < teamList.size(); i++){
			...
			teams.append(": ");
			for(int ti = 0; ti < teamList.get(i).size(); ti++){
